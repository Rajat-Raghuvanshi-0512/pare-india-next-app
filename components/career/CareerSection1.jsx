    ...
    <section className="p-5 pt-20 md:p-10 lg:p-20">
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        <div className="pt-8">
          ...
          <Button className={'hidden md:mt-4 md:block lg:mt-6'} onClick={() => router.push('/career-form')}>
            apply now
          </Button>
        </div>
        <div className="p-4 pl-10 md:p-0">
          <div className="relative">
            ...
            <Image src={Career1} alt={'career1'} width={550} height={415} className=" mt-3 h-full w-full  lg:mt-5" />
          </div>
          <Button className={'mt-5 !px-14 md:mt-4 md:hidden lg:mt-6'} onClick={() => router.push('/career-form')}>
            apply now
          </Button>
        </div>
      </div>
