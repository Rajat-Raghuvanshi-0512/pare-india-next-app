          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col gap-3 2xl:gap-10">
              ...
              <ul className="form-dropdown relative border-b-2 border-[#adadad] bg-black-base bg-transparent p-1  font-montserrat text-[#adadad] outline-none placeholder:uppercase lg:py-3 lg:text-xl 2xl:text-2xl">
                ...
                <li
                  className={`mb-2 mt-5 bg-black-base py-2 text-center text-white ${
                    !open && 'hidden'
                  } `}
                  onClick={() => {
                    setValue('walls');
                ...
                <li
                  className={`mb-2 bg-black-base py-2 text-center text-white ${
                    !open && 'hidden'
                  } `}
                  onClick={() => {
                    setValue('ceiling');
            ...
            <Button
              variant="outlined"
              type="submit"
              className={'2xl:px-10 2xl:py-4 2xl:text-2xl'}
              disabled={loading}
            >
              SEND REQUEST
            </Button>
