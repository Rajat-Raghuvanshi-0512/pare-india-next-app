'use client'
import { BrochureImg, BrochurePhoneImg, CircularDownArrow, LongDownArrow } from '@/utils/assets'
...
const ResourceSection1 = () => {
  ...
  return (
    <section className="relative p-5 pl-0 pt-20">
      ...
      <Image src={CircularDownArrow} alt="down" className="mx-auto hidden w-[70px] md:block" />
      <Image src={LongDownArrow} alt="down" className="absolute right-4 top-52 md:hidden" />
      <div className="grid grid-cols-2 lg:gap-10 lg:p-20 lg:pb-0 2xl:px-40">
        ...
        <div className="flex flex-col gap-5 text-right lg:gap-7 2xl:gap-12">
          ...
          <Button className={'ml-auto w-fit'} onClick={() => {
            "use client"
