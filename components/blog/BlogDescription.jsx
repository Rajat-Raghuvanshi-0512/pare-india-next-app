  ...
  return (
    <section className="p-5 md:px-20 lg:px-60 lg:pb-20">
      ...
      <div className="share flex items-center gap-5 py-5">
        ...
        <Image src={FacebookIcon} alt="fb" width={40} className="object-cover" />
        <Image src={TwitterIcon} alt="twitter" width={40} className="object-cover" />
        <Image src={PinterestIcon} alt="pinterest" width={40} className="object-cover" />
      </div>
